...
import {  Download, Zap, ArrowRight, Network, Github, File } from "lucide-react"
  ...
  const features = [
    {
      ...
      description: "Import your complete Github profile instantly",
    },
    {
      icon: File,
      title: "Network Sync",
      description: "Sync Projects and Repository seamlessly",
    },
    {
      icon: Zap,
      title: "Auto-Update",
      description: "Keep your resume current with Guthub changes",
    },
  ]
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-8">
          ...
          >
            ...
            <br />
            <motion.span
              className="inline-block bg-gradient-to-r from-white to-gray-800 bg-clip-text text-transparent"
              initial={{ y: 80 }}
              animate={{ y: 0 }}
        ...
        <motion.div variants={itemVariants} className="mb-12">
          ...
          >
            Transform your github account into a stunning resume in seconds.
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 max-w-4xl mx-auto ">
          {features.map((feature, index) => (
            ...
            >
              <motion.div
                className="w-12 h-12  rounded-xl flex items-center justify-center mb-4 bg-black text-white transition-all duration-300"
                whileHover={{ rotate: 5 }}
              >
        ...
        <motion.div variants={itemVariants}>
          ...
          >
            Join 2,500+ professionals waiting for this feature
          </motion.p>
        </motion.div>
